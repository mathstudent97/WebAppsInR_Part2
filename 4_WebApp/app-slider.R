...
# This is just another version of the#
#app shown in 'app-numeric.R'        #

# So, make sure to clean the         #
#environment after running the app   #
#shown in the 'app-numeric' file     #
...
ui <- pageWithSidebar(
  ...
  # Page header
  headerPanel('Iris Predictor App'),
  ...
  sidebarPanel(
    ...
    sliderInput("Sepal.Length", label = "Sepal Length", value = 5.0,
                ...
                # Want: TrainSet object and Sepal Length column
