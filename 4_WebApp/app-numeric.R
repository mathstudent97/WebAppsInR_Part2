...
server<- function(input, output, session) {
  ...
  datasetInput <- reactive({  
    ...
    df <- rbind(df, Species)
    input <- transpose(df)
        # The 3 lines above help create a data frame.
    ...
    # Generally, the csv file containing the input parameters will be generated using the block of code above.
...
# Generally, the block of code above, shows the output prediction results.
